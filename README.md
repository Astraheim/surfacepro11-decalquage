...
- 🔆 **Régler la luminosité** de l'écran directement depuis l'interface, avec
  relecture automatique de la vraie valeur matérielle pour rester toujours
  synchronisée avec l'écran
...
- 🔆 **Luminosité accessible aussi une fois l'image affichée** (boutons − / + dans la barre d'outils), avec la fenêtre principale et la barre d'outils toujours affichées en phase l'une avec l'autre
...
- 📂 **Barre d'outils repliable**, toujours ancrée au-dessus de l'image (aucun conflit de premier plan) : un bouton « Réduire » la ramène à une simple languette pour dégager l'écran, et **Ctrl+M** la replie/déplie au clavier à tout moment
...
- 📐 **Grille légère optionnelle**, avec une taille de case réglable en pixels (aide au cadrage), une case à cocher disponible aussi bien dans la fenêtre principale que dans la barre d'outils flottante, et une explication affichée directement dans l'interface
...
3. Dans la fenêtre :
   - choisis la langue de l'interface si besoin (sélecteur en haut à droite) ;
